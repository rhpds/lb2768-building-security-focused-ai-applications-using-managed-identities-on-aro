...
+
.. Run the following command (but replace the url) `cd ; wget https://website.hosting/.env` to will download the credentials to connect to various Azure AI services.
+
.. Close the terminal.
+

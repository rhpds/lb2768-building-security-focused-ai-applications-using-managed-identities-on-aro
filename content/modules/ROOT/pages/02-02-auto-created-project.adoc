...
* Open the project called {user} by clicking on {user}
+
[.bordershadow]
image::02/02-02-click-on-user-x.png[]
...
3. A Data Connection - it contains all the information needed to talk with an existing cloud storage bucket, we use that to store models and pipeline artifacts.

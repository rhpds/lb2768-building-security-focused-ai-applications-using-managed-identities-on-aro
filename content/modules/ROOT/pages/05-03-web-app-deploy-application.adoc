...
spec:
  ...
  source:
    ...
    repoURL: https://github.com/rhpds/lb2768-building-security-focused-ai-applications-using-managed-identities-on-aro.git
    targetRevision: main
  syncPolicy:
    automated:
      prune: true
...
- Make sure you have your project selected: `{user}`
